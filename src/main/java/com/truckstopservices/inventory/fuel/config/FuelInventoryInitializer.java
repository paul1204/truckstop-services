...
public class FuelInventoryInitializer {
    ...
    public CommandLineRunner loadFuelInventoryData() {
        return args -> {
            dieselRepository.save(new Diesel("02/24/2025",40, 2.99, 10000));
            regularFuelRepository.save(new RegularOctane("02/24/2025",87, baseGasPrice ,10000));
          //  midGradeFuelRepository.save(new MidGradeOctane("02/24/2025",89, (baseGasPrice + 0.25), 100));
            premimumFuelRepository.save(new PremiumOctane("02/24/2025",91, (baseGasPrice + 0.50),5000));
        };
    }
}