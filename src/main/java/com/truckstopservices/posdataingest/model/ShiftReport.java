...
public class ShiftReport {
    ...
    public ShiftReport(String date, String shiftNumber, String employeeID, String managerID, double posCashTil1, double posCashTil2, double fuelSaleRegular, double fuelSalesMidGrade, double fuelSalesPremium, double fuelSalesDiesel, double convenienceStoreSales, double restaurantSales, double tobaccoSales) {
        this.date = date;
