...
public class TruckDriverFuelService {
    ...
    public FuelSaleHouseAccountResponse updateDieselInventoryFIFOSalesHouseAccount(double gallonsSold, String houseAccountId, String terminal) throws FuelSaleException {
        ...
        // Use the credit limit check in HouseAccountService
        houseAccountService.adjustBalance(houseAccountId, fuelSaleResponse.totalPrice(), fuelSaleResponse.gallonsSold());
